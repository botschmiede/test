...
export default function AgentsPage() {
  const InfoCard = (
    <div className="p-4 md:p-8 rounded bg-[#25252d] w-full max-h-[85%] overflow-hidden">
      ...
      Lasse einen Agenten deine Aufgabe erledigen 🦜
      </h1>
    {/*   <h1 className="text-3xl md:text-4xl mb-4">
  ...
  return (
    <ChatWindow
      ...
      placeholder="Kreisch! Ich bin ein konversationeller Agent! Fragen Sie mich nach dem aktuellen Wetter in Honolulu!"
      titleText="Polly, der Agenten-Papagei"
      emoji="🦜"      
